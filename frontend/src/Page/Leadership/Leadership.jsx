      ...
      <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
        <div className="md:w-2/3">
          ...
          <div className="text-lg text-gray-600 space-y-6">
            <p>안녕하세요, X자산운용사 대표이사 이대표입니다.</p>
            <p>
              저희 x자산운용사는 20년 이상의 전기 산업 경력을 바탕으로, 통찰력과
              실행력을 통해 고객 여러분께 최상의 가치를 제공하기 위해
              노력하고 있습니다.
            </p>
            <p>
              급변하는 글로벌 시장 환경 속에서도 지속적인 투자전략 수립을
              통해 최적의 시장 대응능력과 펀드 수익률을 제공하겠습니다.
            </p>
