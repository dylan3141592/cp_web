    ...
    <div className='bg-white'>
      <div className='container mx-auto px-4 py-28 lg:py-0 max-w-6xl'>
        ...
        <div className='flex justify-end mb-4'>
          <Link to="/board" className="px-5 py-2 bg-white text-gray-900 rounded-lg hover:bg-gray-100 transition-colors duration-300 flex items-center gap-2 border border-gray-200 "
        ...
        <div  className='bg-white rounded-xl shadow-lg overflow-hidden'>
          {dummyPosts.length === 0 ? (
            ...
            dummyPosts.map((post)=>(
              <div key={post._id} className='border-b border-gray-100 last:border-b-0 hover:bg-blue-50 transition'>
