...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white text-black p-4 shadow-lg z-40"> 
    <div className= "container mx-auto flex justify-between items-center"> 
        <h1 className="text-2xl lg:text-2xl font-bold lg:ml-10 lg:mr-50"><a href="/">자산운용사</a></h1>
        <div className="hidden lg:flex flex-1 justify-center">
            <ul className="flex gap-8 text-lg">{MenuItems.map((item)=> (
    ...
    >
        <div className='p-4'>
            <button className="text-2xl mb-8 float-right"
                onClick={toggleMenu}
                aria-label="닫기">
